...
<div class="container" style="padding-top:0px; max-width:740px;" id="second">
        	...
        	<!--<nav class="navbar navbar-inverse">
              <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-left">
                 ...
                 <form class="navbar-form" role="search" style=" float:right; width:305px;">
                    <div class="input-group add-on">
                      <input class="form-control" placeholder="Transaction#/Contract#" name="srch-term" id="srch-term" type="text" style="width:250px;">
    ...
    <div class="row">
    	<p class="pp" style="font-weight:normal; font-size:16px; color:#650B14; text-align:center; margin-top:30px; margin: 0 auto; margin-top:50px;">Logged in as <?='1'.str_pad($_SESSION['puid'],9,'0', STR_PAD_LEFT)?>. You are not <?='1'.str_pad($_SESSION['puid'],9,'0', STR_PAD_LEFT)?>? <a href="https://safe.zone/logout.php?domain=ivc.travel">Click here</a> to log in</p>
